  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p style={{ margin: 0, fontFamily: 'var(--font-body)', fontSize: 'var(--text-body)', color: 'var(--color-text-secondary)', lineHeight: 'var(--leading-relaxed)' }}>
          Between elections, the same engine runs against your current officeholders instead of candidates. Nothing about the matching changes: eight dimensions, same confidence bands, same dealbreaker checks. What changes is who gets scored — the people already in the room rather than the people asking to get in.
        </p>
      </>
    ),
  },
