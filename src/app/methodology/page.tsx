  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p style={{ margin: 0, fontFamily: 'var(--font-body)', fontSize: 'var(--text-body)', color: 'var(--color-text-secondary)', lineHeight: 'var(--leading-relaxed)' }}>
          Between elections, the same engine runs against your current officeholders instead of candidates. Nothing about the matching changes: eight dimensions, legislative record weighted 3:1 over rhetoric, dealbreakers surfaced as flags — never exclusions, because you can&apos;t exclude your own senator from being your senator. Officials with thin public records (common for state legislators) carry a plain-language precision caveat instead of a false-precision score. This shows how your values compare to your representatives&apos; actual public record — not a rating or grade.
        </p>
      </>
    ),
  },
