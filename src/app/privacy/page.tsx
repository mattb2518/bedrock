      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-10)" }}>
        ...
        <section>
          ...
          {[
            ...
            ["Finding your districts", "Your address is used to find your congressional and state legislative districts, then stored in your profile so you don't have to retype it. Edit or delete it anytime. It's never shared, sold, or used for anything else — and it's never given to Claude."],
