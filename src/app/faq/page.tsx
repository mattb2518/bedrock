    ...
    <div style={{ maxWidth: 'var(--max-width-content)', margin: '0 auto', padding: 'var(--space-16) var(--space-6)' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
        ...
        <SectionAccordion id="faq-general" title="General" methodologyAnchor="quiz">
          <FAQItem q="Is Bedrock liberal or conservative?" a={<p style={{ margin: 0 }}>Neither. That&apos;s the whole point. Bedrock doesn&apos;t have a political position — it has a methodology. The eight dimensions were designed so that both poles have defensible, honorable positions. We&apos;ve run the &apos;partisan smell test&apos; on every question: if either side feels obviously right or wrong, we rewrote it. Read the full <Link href="/methodology" style={{ color: 'var(--color-blue-accent)' }}>methodology</Link> to see how we checked our work.</p>} />
          <FAQItem q="How do you make sure the questions aren't biased?" a={<p style={{ margin: 0 }}>Two ways. First, structurally: answer order is randomized for every user, scoring keys to an option&apos;s content rather than its position, and the Layer 4 dealbreakers are paired left and right. Second, by review: before launch, every question, answer option, micro-reaction, and historical aside was checked item by item from two directions at once — what a sharp critic on the left would object to, and what a sharp critic on the right would object to. An item only passed if it survived both, with a real home for every honest position and no &apos;fun fact&apos; that quietly takes a side. We don&apos;t claim it&apos;s perfect — bias-checking is ongoing, there&apos;s a feedback button on every question, and when we get one wrong we fix it and say so. The full method is in our <Link href="/methodology" style={{ color: 'var(--color-blue-accent)' }}>Methodology</Link>.</p>} />
          <FAQItem q="Who built this and why?" a={<p style={{ margin: 0 }}>Matt Blumberg — technology entrepreneur, registered independent, frustrated with the political options available to voters who don&apos;t fit neatly in either party. No political backers, no institutional agenda. A person who got frustrated enough to build something. Read the full story on the <Link href="/about" style={{ color: 'var(--color-blue-accent)' }}>About page</Link>.</p>} />
          <FAQItem q="Who funds Bedrock?" a="Right now: Matt personally. No political parties, PACs, political donors, advertising, or any organization with a stake in where you land will ever fund this." />
          ...
          <FAQItem q="What is a Civic Mantle?" a="Your Civic Mantle is a named summary of your eight-dimensional profile — one of ten Mantles that captures where you tend to cluster across the dimensions. Think of it like a personality type, but for your political identity. It's a shortcut for communication, not a box. Your full constellation (the radar chart) is more precise. The Mantle is just the plain-English version." />
          <FAQItem q="Do I have to create an account?" a="No — you can take the quiz and see your results without an account. But to save your civic profile and results, access your matches — ballot or officials, depending on the season — Your Media Diet, and Your Conversations, you'll need to create one. It's free. You can sign up with an email and password, a magic link (no password needed), or Google. If you're privacy-conscious about Google Sign-In, email is just as easy — we don't treat you differently either way." />
          <FAQItem q="What do you do with my quiz answers?" a="Use them to power your experience — your ballot and officials matches, Your Media Diet, Your Conversations. That's it. We never sell your data, share your profile with political organizations, or use it for advertising. The full privacy policy is on the Privacy & Data page." />
        ...
        {/* ── §26.2 Your Ballot ─────────────────────────────────────────────── */}
        <SectionAccordion id="faq-ballot" title="Your Ballot & Your Officials" methodologyAnchor="ballot">
          <FAQItem q="What's Your Officials?" a="Between elections, Bedrock shows you how your values line up with the people already representing you — your two U.S. senators, House rep, governor, and state legislators — based on their public record: votes, sponsorships, statements. Records count three times as much as rhetoric. When election season arrives and the races are set, the same pillar becomes Your Ballot." />
          <FAQItem q="Is this a scorecard or a rating of my representatives?" a="No. There's no grade and no single number. You see your constellation and theirs on the same eight dimensions — where you converge, where you diverge. The divergences aren't demerits; they're the interesting part. The exception is your dealbreakers: if an official has crossed one of your hard lines, we flag it plainly. You decide what to do with that." />
          <FAQItem q="When does Your Officials become Your Ballot?" a="Once the primaries are done and the general-election field is actually set — usually early fall. We flip it deliberately rather than automatically, because 'the races are set' happens at different times in different states and we'd rather show you nothing than something half-baked." />
          <FAQItem q="How do you match me to candidates?" a="When you enter your address, we fetch real candidates from official government data sources and classify them against your values profile in real time. Incumbents with voting records get confident placements. Challengers get real but lower-confidence placements — we're honest about the difference. The analysis is generated by Claude, reviewed by humans for quality, and cached so the experience is fast for everyone who looks up your district after the first time." />
