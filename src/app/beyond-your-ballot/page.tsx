        ...
        {savedAddress && !showAddressInput ? (
          ...
          <>
            <p style={{ margin: '0 0 var(--space-3)', fontFamily: 'var(--font-body)', fontSize: 'var(--text-small)', color: 'var(--color-text-secondary)', lineHeight: 'var(--leading-relaxed)' }}>
              {hasProfile
                ? 'Add your address so we can personalize your recommendations when they\'re ready.'
                : 'Add your address to personalize your recommendations. Then create an account so we can email you when they go live.'}
            </p>
            <AddressAutocomplete
