    ...
    <div style={{ maxWidth: "var(--max-width-content)", margin: "0 auto", padding: "var(--space-16) var(--space-6)" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-12)" }}>
        ...
        <section>
          ...
          <p style={{ fontFamily: "var(--font-body)", fontSize: "var(--text-body)", color: "var(--color-text-secondary)", lineHeight: "var(--leading-relaxed)" }}>Three things built on top of it: <strong style={{ color: "var(--color-text-primary)" }}>Your Ballot</strong> — every race matched to your values, printable. <strong style={{ color: "var(--color-text-primary)" }}>Your Media Diet</strong> — a three-tier recommendation that makes you a smarter citizen. <strong style={{ color: "var(--color-text-primary)" }}>Your Conversations</strong> — Claude-powered prep for difficult conversations across difference.</p>
        </section>
